...
class Options:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--eval_freq', type=int, default=1500, help='# of step to do eval')
        ...
        parser.add_argument('--crop_size_source', type=tuple, default=(512, 1024), help='For source, Crop to the width of crop_size')
        parser.add_argument('--crop_size_target', type=tuple, default=(1024, 2048), help='For target, Crop to the width of crop_size')
        ...
        parser.add_argument('--source_dataroot', type=str, default='/content/drive/MyDrive/MLDL/data/GTA5/')
        parser.add_argument('--target_dataroot', type=str, default='/content/drive/MyDrive/MLDL/data/cityscapes/')
        parser.add_argument('--mean', type=int, default=(73.158359210711552, 82.908917542625858, 72.392398761941593), help='dataset mean')
        ...
        parser.add_argument('--weight_decay', type=float, default=5e-4, help='weight decay optimizer')
        parser.add_argument('--seg_lr', type=float, default=5e-4, help='learning rate for scene parser')
        ...
        # for discriminators
        parser.add_argument('--lambda_adv', type=float, default=0.01, help="lambda adv for discriminator 0.01")
        parser.add_argument('--d_lr', type=float, default=1e-5, help='learning rate for discriminators')
